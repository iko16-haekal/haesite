        ...
        >
          ...
          <div className="border-color-footer-2-2 mx-auto">
            ...
            <div className="container mx-auto flex pt-12 flex-col lg:flex-row items-center space-y-5 lg:space-y-0">
              <div
                className="flex title-font font-medium items-center text-gray-900 mb-4 lg:mb-0 md:mb-0 space-x-5"
                style={{ cursor: "pointer" }}
              >
                <svg
                  className="social-media-c-footer-2-2"
                  width={30}
                  height={30}
                  viewBox="0 0 30 30"
                  fill="none"
                ...
                <svg
                  className="social-media-p-footer-2-2"
                  width={30}
                  height={30}
                  viewBox="0 0 30 30"
                  fill="none"
              ...
              <nav className="mx-auto flex flex-wrap items-center text-base justify-center">
                <a className="mr-5 footer-link-footer-2-2">Terms of Service</a>
                <span className="mr-5">|</span>
                <a className="mr-5 footer-link-footer-2-2">Privacy Policy</a>
                <span className="mr-5">|</span>
                <a className="mr-5 footer-link-footer-2-2">Licenses</a>
              </nav>
